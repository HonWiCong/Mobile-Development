...
class ToReceiveFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val recyclerView = view.findViewById<RecyclerView>(R.id.to_receive_list)
        recyclerView.layoutManager = LinearLayoutManager(context)

        val orderList = ArrayList<Order>()
        val adapter = PurchasedRecyclerViewAdapter({ orderList }, requireContext(), "To Receive")
    ...
    companion object {
        ...
        fun newInstance(tabTitle: String): ToReceiveFragment {
            val fragment = ToReceiveFragment()
            val args = Bundle()
