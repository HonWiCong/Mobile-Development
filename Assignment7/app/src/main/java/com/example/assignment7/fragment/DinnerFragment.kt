...
class DinnerFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val recyclerView = view.findViewById<RecyclerView>(R.id.dinner_list)
        recyclerView.layoutManager = LinearLayoutManager(requireContext())

        val dinnerLinkList = ArrayList<String?>()
        val dinnerRecipeList = ArrayList<Recipe>()

        val url = "https://api.edamam.com/api/recipes/v2?type=public&app_id=1ebd0db1&app_key=4fae7ddfb922cf36e09e1d6e10ff1802&cuisineType=Japanese&mealType=Dinner&field=cuisineType"
            ...
            Request.Method.GET, url, null, { response ->
                try {
                    ...
                    while (i < 8) {
                        ...
                        dinnerLinkList.add(link)
                        if (dinnerLinkList.isEmpty()) {
                        ...
                        val json = JsonObjectRequest(
                            Request.Method.GET, link, null, { response ->
                                try {
                                    ...
                                    recyclerView.adapter = RecipeItemRecycleViewAdapter(dinnerRecipeList, requireContext())
