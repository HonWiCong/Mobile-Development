...
class OrderToShipFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_order_to_ship, container, false)
        ...
        database
            ...
            .addOnSuccessListener {
                ...
                recyclerView.adapter = OrderRecyclerViewAdapter(orderList, view.context, "To Ship")
            }
    ...
    companion object {
        ...
        fun newInstance(tabTitle: String): OrderToShipFragment {
            val fragment = OrderToShipFragment()
            val args = Bundle()
